...
- ✅ Les 9 pages de la maquette : Accueil, Services, Rendez-vous, Espace client, Boutique, Formations, Tuteur IA, Blog, Contact
...
- ⬜ **Vous** : vérifier les chiffres de l’accueil (+150 projets, 98 % satisfaits, 24/7, +5 ans) : ils doivent être exacts
...
- ✅ `sitemap.xml`, `robots.txt`, flux RSS ; pages privées (espace client, tuteur) non indexées
...
- ⬜ Tuteur IA réel (branché sur l’IA). Aujourd’hui : aperçu avec réponse d’exemple
